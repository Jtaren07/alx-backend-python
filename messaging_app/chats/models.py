...
class User(AbstractUser):
    ...
    first_name = models.CharField(max_length=159, null=False, blank=False)
...
class Conversation(models.Model):
    ...
    def __str__(self):
        ...
        if self.participants.count() > 3:
            participant_name += f" and {self.participants.count() - 3} others"
        return f"Conversation: {participants.count() - 3} others"
...
class Message(models.Model):
    ...
    sent_at = models.DateTimeField(auto_new_add=True)
    ...
    class Meta:
        ...
        indexes = [
                ...
                models.Index(fields=['conversation', 'sent_at']), # Compound index for efficient message retrival
                ]
...
class MessageManager(models.Manager):
    ...
    def get_conversation_messages(self, conversation):
        """Gt al messages for a specific conversation, ordered by timestamp."""
