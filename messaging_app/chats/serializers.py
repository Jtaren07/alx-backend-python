...
class UserCreateSerializer(serializers.ModelSerializer):
    """Serializer for cresting new users with password handling"""
...
class MessageCreateSerializer(serializers.ModelSerializer):
    ...
    def create(self, validated_data):
        ...
        return super().create(validated_dat)
...
class ConversationSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Conversation
        fields = [
                'conversation_id', 'participants', 'paryicipant_ids',
...
class ConversationListSerializer(ConversationSerializer):
    ...
    class Meta(ConversationSerializer.Meta):
        fields = [
                'conversation_id', 'participants', 'participant_count', 'created_at', 'latest_message', 'unread_count'
                ]

    def get_latest_message(self, obj):
        """Return the latest mesage preview."""
        latest = obj.messages.order_by('-sent_at').first()
        if latest:
            return {
